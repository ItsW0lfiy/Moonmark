...
The Avalonia experiment is now discontinued because its required runtime model conflicts with Moonmark's runtime and distribution policy. This is an architectural and packaging decision, not a claim that the experiment technically failed. The measured Windows x64 results were approximately:
