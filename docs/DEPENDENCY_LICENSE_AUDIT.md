...
Audit date: 2026-09-10. Target: Moonmark 0.1.0-dev.6, Windows x64. This is an engineering record, not legal advice.
...
Moonmark uses Qt 6.11.2 Core, Gui, Widgets, and the `qwindows` platform plugin. Qt documents those essential components as available under LGPLv3/GPLv3. Moonmark dynamically links them and ships the LGPLv3 and GPLv3 texts. It does not use Qt WebEngine, Qt Quick, QML, or a GPL-only add-on module.
