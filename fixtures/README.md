...
`moonmark-visual-test.md` is the committed wide-layout visual fixture. Its geometric images live in `fixtures/images`. `task-list-visual.md` is a focused fixture for native achromatic task boxes, nested lists, and ordinary list markers.
...
`markdown-compatibility.md` covers Moonmark's deliberate CommonMark, GFM, reference-link, footnote, and inert-HTML profile through the semantic and native presentation paths.
